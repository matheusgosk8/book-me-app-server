...
// Example usage:
// err := repositories.RunInTx(ctx, client, func(ctx context.Context, tx *ent.Tx) error {
//     if _, err := tx.User.Create().SetNome("x").Save(ctx); err != nil {
//         return err
//     }
//     if _, err := tx.Address.Create().SetStreet("x").Save(ctx); err != nil {
//         return err
//     }
//     return nil
// })
