...
func (_c *SessionCreate) SetLastLoginAt(v time.Time) *SessionCreate {
	_c.mutation.SetLastLoginAt(v)
	return _c
}

// SetNillableLastLoginAt sets the "last_login_at" field if the given value is not nil.
func (_c *SessionCreate) SetNillableLastLoginAt(v *time.Time) *SessionCreate {
	if v != nil {
		_c.SetLastLoginAt(*v)
	}
	return _c
...
func (_c *SessionCreate) check() error {
	...
	if _, ok := _c.mutation.LastLoginAt(); !ok {
		return &ValidationError{Name: "last_login_at", err: errors.New(`ent: missing required field "Session.last_login_at"`)}
	}
