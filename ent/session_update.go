...
func (_u *SessionUpdate) SetLastLoginAt(v time.Time) *SessionUpdate {
	_u.mutation.SetLastLoginAt(v)
	return _u
}

// SetNillableLastLoginAt sets the "last_login_at" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableLastLoginAt(v *time.Time) *SessionUpdate {
	if v != nil {
		_u.SetLastLoginAt(*v)
	}
	return _u
...
// SetLastLoginAt sets the "last_login_at" field.
func (_u *SessionUpdateOne) SetLastLoginAt(v time.Time) *SessionUpdateOne {
	_u.mutation.SetLastLoginAt(v)
	return _u
}

// SetNillableLastLoginAt sets the "last_login_at" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableLastLoginAt(v *time.Time) *SessionUpdateOne {
	if v != nil {
		_u.SetLastLoginAt(*v)
	}
	return _u
